...
namespace SermoWeb.Controllers
{
    public class RatingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Author,Content")] Ratings ratings)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Author,Content")] Ratings ratings)
        {
            if (id != ratings.Id)
            {
                return NotFound();
